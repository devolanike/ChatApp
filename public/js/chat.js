...
onAuthStateChanged(auth, (user) => {
  if (user) {
    ...
    displayProfile.innerHTML += `<div class='d-flex flex-column justify-content-center align-items-center gap-2'>
    <div class='d-flex flex-column justify-content-center align-items-start gap-2'>
          ...
          <img src="${user.photoURL}" alt="DP" width='60%' style='border-radius: 100%'></div>`;
  } else {
    // User is signed out
    setTimeout(() => {
